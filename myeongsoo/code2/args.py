...
def parse_args(mode="train"):
    ...
    parser.add_argument(
        "--asset_dir", default="/opt/ml/asset/", type=str, help="data directory"
    )
    parser.add_argument(
        "--feature_type",
        default="ver1",
        type=str,
        help="feature combination you choose",
    )
    ...
    parser.add_argument(
        "--model_dir", default="/opt/ml/models/", type=str, help="model directory"
    )
    parser.add_argument(
        "--model_name", default="model.pt", type=str, help="model file name"
    )
    parser.add_argument(
        "--output_name", default="output.csv", type=str, help="model file name"
    )

    parser.add_argument(
        "--output_dir",
        default="/opt/ml/output/sweep",
        type=str,
    ...
    parser.add_argument(
        "--max_seq_len", default=1000, type=int, help="max sequence length"
    )
    ...
    parser.add_argument(
        "--interaction_type",
        default="problem_number",
        type=str,
        help="how to embed the interaction",
    )
    # 훈련
    ...
    parser.add_argument(
        ...
        default=True,
        type=bool,
        help="for seperate the sequence by grade",
    )
    parser.add_argument(
        "--augment_rate", default=0.7, type=float, help="percent to augment"
    )
    parser.add_argument(
        "--augment", default=True, type=bool, help="for augment the seq length various"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=True,
        type=bool,
        help="for apply cv strategy for train/valid split",
    )
    parser.add_argument(
        "--cv_test",
        default=True,
