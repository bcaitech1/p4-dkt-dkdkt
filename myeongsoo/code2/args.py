...
def parse_args(mode='train'):
    ...
    parser.add_argument('--output_dir', default='/opt/ml/output/sweep', type=str, help='output directory')
    ...
    parser.add_argument('--augment_rate', default=0.7, type=float, help='percent to augment')    
    ...
    parser.add_argument('--cv_test', default=True, type=bool, help='for apply cv strategy for train/valid split')
    parser.add_argument('--slide', default=True, type=bool, help='for apply cv strategy for train/valid split')
    parser.add_argument('--window_size', default=15, type=int, help='for apply cv strategy for train/valid split')

    parser.add_argument('--hm_ts', default=4, type=int, help='for apply cv strategy for train/valid split')
